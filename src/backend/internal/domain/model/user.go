...
type Defect struct {
	...
	SourceType        string         `gorm:"type:varchar(20);default:'image'" json:"source_type"`
	SourceTaskID      *string        `gorm:"type:varchar(64);index" json:"source_task_id,omitempty"`
	TrackID           *string        `gorm:"type:varchar(64);index" json:"track_id,omitempty"`
	FirstSeenAt       *time.Time     `json:"first_seen_at,omitempty"`
	LastSeenAt        *time.Time     `json:"last_seen_at,omitempty"`
	ObservationCount  int            `gorm:"default:0" json:"observation_count"`
	BestFramePath     string         `gorm:"type:varchar(255)" json:"best_frame_path"`
	BestResultPath    string         `gorm:"type:varchar(255)" json:"best_result_path"`
	MeasurementSource string         `gorm:"type:varchar(32);default:'unknown'" json:"measurement_source"`
	MeasurementStatus string         `gorm:"type:varchar(32);default:'pending'" json:"measurement_status"`
